...
import { DeployContractSolidityBytecodeV1RequestNoKeychain } from "../generated/openapi/typescript-axios";
...
export class DeployContractSolidityBytecodeEndpointNoKeychain
  ...
  public get className(): string {
    return DeployContractSolidityBytecodeEndpointNoKeychain.CLASS_NAME;
  }
  ...
  public async handleRequest(req: Request, res: Response): Promise<void> {
    ...
    const reqBody: DeployContractSolidityBytecodeV1RequestNoKeychain = req.body;
    try {
      const resBody = await this.options.connector.deployContractNoKeychain(
        reqBody,
      );
      res.json(resBody);
    } catch (ex) {
